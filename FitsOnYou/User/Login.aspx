<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FitsOnYou.User.Login" %>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        <img id="userLogin" src="../Images/login.jpg" alt="img-thumbnail" />
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <div class="btn_box">
                            ...
                            <span class="pl-3 text-info">New User? <a href="Registration.aspx" class="badge bagde-info">Register Here...</a></span>
                        </div>
                    </div>
                </div>
            </div>
